var DatatablesBasicBasic = function() {
	...
	var initTable1 = function() {
...

				{
					...
					render: function(data, type, full, meta) {
						return `
                         ...
                         <a id="excluir"class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Deletar" data-cupom="`+full[0]+`" >
		...
		table.on('click', '#excluir', function() {
			var id_cupom = $(this).data("cupom");
			swal.fire({
	            title: 'Tem certeza?',
	            text: "Desejar excluir o Cupom?",
	            type: 'warning',
	            ...
	            if (result.value) {
					$.ajax({
				        url: 'appCupom/excluir_cupom.php'
				        , type: 'post'
