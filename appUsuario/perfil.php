								...
								<div class="col-xl-12" id="perfil">
                                    <div class="card card-custom card-stretch">
                                        <div class="p-10">
														...
														<div class="modal-body text-center">
															...
															<!-- <div class="dropzone dropzone-default text-center" id="kt_dropzone_1">
																<div class="dropzone-msg dz-message needsclick">
																	...
																	<div>
																		<p class="texto-chumbo dropzone-msg-title">Arraste e solte a sua imagem aqui</p>
																	</div>
																</div>
															</div>
															<div class="my-4">
															...
															<div class="my4 w-100"style="display:inline-grid;">
																<form name="form_foto" id="form_foto" style="display:grid;">
                                            ...
                                            <div class="separator separator-solid"></div>
                                            <div class="my-6">
                                                <button type="button"class="btn btn-outline-primary" id="botao_editar">
