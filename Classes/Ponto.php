    ...
    class Ponto{
		...
		function BuscarDadosPonto($id_ponto)
		{
			try{
				...
				$select = "SELECT 
							id_ponto, ds_descricao, ds_latitude, ds_longitude, f.ds_foto, nu_valor, ds_tipo, ds_observacao, ds_local, ds_tamanho,  p.id_midia, id_material, id_periodo, id_parceiro
						FROM tb_ponto p
						inner join tb_tipo_midia t on p.id_midia=t.id_midia
