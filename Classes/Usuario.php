<?php
	...
	class Usuario{
		...
		public function gravarUsuario(array $dados)
		{
			...
			try{
				$con = Conecta::criarConexao();
				$insert = "INSERT into tb_usuario (ds_nome, ds_usuario, ds_email, ds_endereco, ds_senha, id_perfil)
							VALUES (:ds_nome, :ds_usuario, :ds_email, :ds_endereco, :ds_senha, :id_perfil)";
		...
		function buscarDadosUsuario($id_usuario)
		{
			try{
				...
				$select = "SELECT 
							id_usuario, ds_nome, ds_email, ds_usuario, id_perfil, nu_cpf, ds_foto
						FROM tb_usuario  
