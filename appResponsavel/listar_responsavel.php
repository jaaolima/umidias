<?php
    ...
    $retorno = $responsavel->listarResponsavel($_POST);
?>
		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					&nbsp;
					<a href="appResponsavel/cadastro.php" class="btn btn-light-primary font-weight-bolder dropdown-toggle">
...
<script src="./assets/js/datatables/appResponsavel/lista_responsavel.js" type="text/javascript"></script>
