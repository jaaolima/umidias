            ...
            <div class='card-body text-center' style='padding: 0px !important'>
                ...
                <div class='my-8 mx-15 text-left'>
                    <div class='d-flex ml-n8'>
                        ...
                        <div class='ml-2'>
                            <a style='text-overflow: ellipsis;-webkit-box-orient: vertical;display: -webkit-box;-webkit-line-clamp: 2;overflow: hidden;' href='appCliente/ver_midia.php?id_ponto=".$dados['id_ponto']."&id_midia=".$dados['id_midia']."'class='text-dark font-weight-bold text-dark font-size-h4'>".$dados['ds_local']."</a>
                        </div>	
                    </div>																								
