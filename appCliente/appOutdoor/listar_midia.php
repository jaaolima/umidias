									...
									<div class="col-3">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center" style="padding: 0px !important">
												<!--begin::User-->
												<div class="" >
													<img class="img-fluid w-100" src="assets/media/outdoor.jpg" alt="image" />
													<div class="">
												...
												<div class="my-8 mx-15 text-left">
													...
													<div class="my-6">
														<p class="texto-chumbo font-size-h6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem perferendis dolore culpa vitae neque sapiente maxime</p>
													</div>													
												</div>
												<div class="my-8 mx-15 text-left">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<div class="my-8 mx-4 text-right">
													<a href="appCliente/appOutdoor/ver_midia.php" class="text-primary">Ver detalhes</a>
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
