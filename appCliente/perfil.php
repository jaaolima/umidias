                                    ...
                                    <div class="card card-custom card-stretch">
                                        <div class="p-10">
                                            ...
                                            <div class="my-6 d-flex" id="kt_quick_user_toggle">
											 	<div class="dropdown">
													<div class=" symbol symbol-circle symbol-80 symbol-light-success overlay" >
														<img src="assets/media/maria.jpg" class="symbol-label font-size-h5 font-weight-bold overlay-wrapper"alt=""> 
														<a class="overlay-layer symbol-circle " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
