								...
								<div class="col-xl-12">
                                    <div class="card card-custom card-stretch">
                                        <div class="p-10">
                                            ...
                                            <div class="my-6 ">
                                                <span class="symbol symbol-circle symbol-80 symbol-light-success overlay dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<img src="assets/media/maria.jpg" class="symbol-label font-size-h5 font-weight-bold overlay-wrapper"alt=""> 
													<a class="overlay-layer symbol-circle">
