                                    ...
                                    <div class="card card-custom card-stretch">
                                        <div class="p-10">
                                            ...
                                            <div class="my-6 d-flex" id="kt_quick_user_toggle">
                                                <button type="button" class="symbol symbol-circle symbol-80 symbol-light-success overlay dropdown" href="javascript:;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
