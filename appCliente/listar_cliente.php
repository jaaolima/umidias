		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					&nbsp;
					<a href="appCliente/cadastro.php" class="btn btn-light-primary font-weight-bolder dropdown-toggle">
...
<script src="./assets/js/datatables/appCliente/lista_cliente.js" type="text/javascript"></script>
