<?php
    ...
    $perfil = new Perfil();
    $retorno = $perfil->listarPerfil($_POST);
?>
		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					&nbsp;
					<a href="appPerfil/cadastro.php" class="btn btn-light-primary font-weight-bolder">
...
<script src="./assets/js/datatables/appPerfil/lista_perfil.js" type="text/javascript"></script>
