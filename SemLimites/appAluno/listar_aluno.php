		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					&nbsp;
					<a href="appAluno/cadastro.php" class="btn btn-light-primary font-weight-bolder">
...
<script src="./assets/js/datatables/appAluno/lista_aluno.js" type="text/javascript"></script>
