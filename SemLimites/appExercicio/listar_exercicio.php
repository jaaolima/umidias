<?php
    ...
    $retorno = $exercicio->listarExercicio($_POST);
?>
...
<script src="./assets/js/datatables/appExercicio/lista_exercicio.js" type="text/javascript"></script>
