										...
										<div class="row">
                                            <div class="col-xl-12">
												...
												<div class="position-absolute text-center"  style="top: 150px;bottom: 0;left: 0;right: 0;">
													...
													<br>
													<a class="btn mt-20 rounded" href="appCliente/listar_tipo.php" style="background-color: Transparent; border:1px solid;color:#ffffff;border-image: linear-gradient(90deg, rgba(184,36,254,1) 0%, rgba(245,196,200,1) 100%);border-image-slice: 1;">
