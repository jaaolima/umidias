													...
													<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-white" style="height: 300px; ">
														<div class="card-body d-flex">
															<div class="d-flex py-5 flex-column align-items-start flex-grow-1">
																...
																<div class="row m-0">
																	<a href="midias/appOutdoor/add_midia.php" class="col bg-white px-3 py-6 rounded-xl mr-7 mb-10 mt-7 card-2" :hover style="text-align: center;">
																	...
																	<a href="#" class="col bg-white px-3 py-6 rounded-xl mr-7 mb-10 mt-7 card-2" style="text-align: center;">
																		<span class="svg-icon svg-icon-2x svg-icon-white d-block my-2">
