						...
						<div class="main d-flex flex-column flex-row-fluid">
							<div class="container-fluid d-flex align-items-stretch justify-content-between mt-10" style="padding-right: 30px;">
								...
								<div class="topbar">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0 show" style="position: absolute; transform: translate3d(-310px, -25px, 0px); top: 0px; left: 0px; will-change: transform;" x-placement="top-end">
										<!--begin::Header-->
