					...
					<div class="aside-menu-wrapper flex-column-fluid position-relative" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu mb-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 825px; overflow: hidden;">
							...
							<ul class="menu-nav nav-pills">
								...
								<li class="menu-item my-4 botao-menu botao-menu-alugadas mr-20 btn ml-5" aria-haspopup="true" data-menu-toggle="hover">
								...
								<li class="menu-item my-4 botao-menu botao-menu-financeiro mr-20 btn ml-5" aria-haspopup="true" data-menu-toggle="hover">
																...
																<div class="row m-0 col-12 justify-content-center" >
																	<?php
																		...
																		$tamanho = 100/ $valor;
																			...
																			echo '<div class="bg-white pl-20 py-6 mb-10 mt-7  pr-20'.if($dados["id_midia"] == end($dados["id_midia"])){""}else{echo "border-right"}.'" style="text-align: center; width:'.$tamanho.'% ;">
																						<span class="svg-icon svg-icon-3x svg-icon-white d-block my-2">
