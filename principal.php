	...
	<body id="kt_body" class="header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				<!--incio do sidebar-->
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto menu" id="kt_aside">
					<!--begin::Brand-->
					<div class="brand flex-column-auto ml-3 mt-10" id="kt_brand" kt-hidden-height="65" style="">
						...
						<!--end::Logo-->
						<!--begin::Toggle-->
						<button class="brand-toggle btn btn-sm px-0 ml-30 icon-close" id="kt_aside_toggle">
