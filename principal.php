					...
					<div class="aside-menu-wrapper flex-column-fluid position-relative" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu mb-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 825px; overflow: hidden;">
							...
							<ul class="menu-nav nav-pills">
								<li class="menu-item my-4 botao-menu botao-menu-dashboard botao-menu-active btn ml-5"  aria-haspopup="true">
								...
								<li class="menu-item my-4  btn ml-5 botao-menu botao-menu-alugar" aria-haspopup="true" data-menu-toggle="hover">
								...
								<li class="menu-item my-4 botao-menu botao-menu-alugadas btn ml-5" aria-haspopup="true" data-menu-toggle="hover">
								...
								<li class="menu-item my-4 botao-menu botao-menu-financeiro btn ml-5" aria-haspopup="true" data-menu-toggle="hover">
