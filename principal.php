							...
							<ul class="menu-nav nav-pills">
								...
								<li class="menu-item my-4 botao-menu botao-menu-financeiro btn ml-5" aria-haspopup="true" style="width:max-content;" data-menu-toggle="hover">
									<a href="/appUsuario/listar_usuario.php" class="btn rounded mx-2 text-left ">
										...
										<span class="menu-text texto-menu texto-menu-financeiro"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gerenc. Usuário</font></font></span>
									</a>
								</li>
								<li class="menu-item my-4 botao-menu botao-menu-financeiro btn ml-5" aria-haspopup="true" style="width:max-content;" data-menu-toggle="hover">
									<a href="/appCategoria/listar_categoria.php" class="btn rounded mx-2 text-left ">
										...
										<span class="menu-text texto-menu texto-menu-financeiro"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gerenc. Categoria</font></font></span>
									</a>
								</li>
								<?php endif ;?>
							</ul>
