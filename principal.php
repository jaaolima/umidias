			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto ml-7 mt-10 " id="kt_brand" kt-hidden-height="65" style="">
						...
						<!--end::Logo-->
						<!--begin::Toggle-->
						<?php /*<button class="kt-aside__brand-aside-toggler btn btn-sm px-0 ml-25" id="kt_aside_toggle">
					...
					<!--end::Brand-->
					<!--begin::Aside Menu-->
					<?php /*<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 825px; overflow: hidden;">
							...
							<ul class="menu-nav nav-pills">
								<li class="menu-item my-4 botao-menu botao-menu-active mr-20 btn ml-5"  aria-haspopup="true">
									<a href="principal.php" class="btn rounded ml-2 text-left  ">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M4 9.3L12.1 3L20.2 9.3V19.2C20.2 19.6774 20.0104 20.1352 19.6728 20.4728C19.3352 20.8104 18.8774 21 18.4 21H5.8C5.32261 21 4.86477 20.8104 4.52721 20.4728C4.18964 20.1352 4 19.6774 4 19.2V9.3Z" fill="#B721FF" stroke="#B721FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
										</svg>
								...
								<li class="menu-item my-4  mr-20 btn ml-5 botao-menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="appCliente/listar_tipo.php" class="btn rounded ml-2 text-left  ">
										<svg  width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M17.2 1H2.8C1.80589 1 1 1.80589 1 2.8V11.8C1 12.7941 1.80589 13.6 2.8 13.6H17.2C18.1941 13.6 19 12.7941 19 11.8V2.8C19 1.80589 18.1941 1 17.2 1Z" stroke="#57616A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
											<path d="M8.20001 17.2H11.8" stroke="#57616A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
								...
								<li class="menu-item my-4 botao-menu mr-20 btn ml-5" aria-haspopup="true" data-menu-toggle="hover">
									<a href="appCliente/listar_minhas_midias.php" class="btn rounded ml-2 text-left  ">
										<svg  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M8 11L11 14L21 4" stroke="#57616A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
							...
							<div class="position-absolute bottom-0 ml-8">
					...
					<div class="kt- kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="principal.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											</svg></span><span class="kt-menu__link-text">Painel de Controle</span></a></li>

								<!--<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="appPaciente/painel_controle.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<polygon id="Bound" points="0 0 24 0 24 24 0 24" />
										<path d="M12.9336061,16.072447 L19.36,10.9564761 L19.5181585,10.8312381 C20.1676248,10.3169571 20.2772143,9.3735535 19.7629333,8.72408713 C19.6917232,8.63415859 19.6104327,8.55269514 19.5206557,8.48129411 L12.9336854,3.24257445 C12.3871201,2.80788259 11.6128799,2.80788259 11.0663146,3.24257445 L4.47482784,8.48488609 C3.82645598,9.00054628 3.71887192,9.94418071 4.23453211,10.5925526 C4.30500305,10.6811601 4.38527899,10.7615046 4.47382636,10.8320511 L4.63,10.9564761 L11.0659024,16.0730648 C11.6126744,16.5077525 12.3871218,16.5074963 12.9336061,16.072447 Z" id="Shape" fill="#000000" fill-rule="nonzero" />
										<path d="M11.0563554,18.6706981 L5.33593024,14.122919 C4.94553994,13.8125559 4.37746707,13.8774308 4.06710397,14.2678211 C4.06471678,14.2708238 4.06234874,14.2738418 4.06,14.2768747 L4.06,14.2768747 C3.75257288,14.6738539 3.82516916,15.244888 4.22214834,15.5523151 C4.22358765,15.5534297 4.2250303,15.55454 4.22647627,15.555646 L11.0872776,20.8031356 C11.6250734,21.2144692 12.371757,21.2145375 12.909628,20.8033023 L19.7677785,15.559828 C20.1693192,15.2528257 20.2459576,14.6784381 19.9389553,14.2768974 C19.9376429,14.2751809 19.9363245,14.2734691 19.935,14.2717619 L19.935,14.2717619 C19.6266937,13.8743807 19.0546209,13.8021712 18.6572397,14.1104775 C18.654352,14.112718 18.6514778,14.1149757 18.6486172,14.1172508 L12.9235044,18.6705218 C12.377022,19.1051477 11.6029199,19.1052208 11.0563554,18.6706981 Z" id="Path" fill="#000000" opacity="0.3" />
								...
								<li class="kt-menu__section ">
									<h4 class="kt-menu__section-text">Paciente</h4>
									<i class="kt-menu__section-icon flaticon-more-v2"></i>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appPaciente/buscar_paciente.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">

									<i class="kt-menu__section-icon flaticon2-search-1"></i></span><span class="kt-menu__link-text">Buscar Paciente</span></a>

								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appPaciente/cadastro.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon-user-add"></i></span><span class="kt-menu__link-text">Adicionar Paciente</span></a>
								</li>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appUsuario/listar_usuario.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon-users"></i></span><span class="kt-menu__link-text">Usuários</span></a>
								</li>
								<!--<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appPaciente/buscar_paciente.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon-home"></i></span><span class="kt-menu__link-text">Hospitais</span></a>
								</li>-->

								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appPaciente/listar_plantao.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon2-writing"></i></span><span class="kt-menu__link-text">Passagem de Plantão</span></a>
								</li>

								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appSetor/listar_setores.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon2-writing"></i></span><span class="kt-menu__link-text">Setor</span></a>
								</li>

								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="appUnidade/listar_unidades.php" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
									<i class="kt-menu__section-icon flaticon2-writing"></i></span><span class="kt-menu__link-text">Unidade</span></a>
								</li>
								...
								<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
										<div class="my-3 d-flex">
											...
											<p class="mb-0 mt-1 ml-2">04 de outubro de 2021</p>
										</div>
									</div>
									<!--end::Header Menu-->
								</div>
								<div class="topbar">
									<div class="topbar-item">
										<div class=" w-auto btn-clean d-flex align-items-center px-2" id="kt_quick_user_toggle">
											...
											<a href="javascript:;" class="ml-3 dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																...
																<div class="row m-0 col-12 justify-content-center" >
																	<?php 
																		...
																		{ 
																			...
																			/*$end = end($dados);
																			var_dump(current($dados));
																			$borda = if()){"border-right"};*/
